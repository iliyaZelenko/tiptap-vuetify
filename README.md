...
The dialog options can be changed by setting `options.dialogProps`, with an object following props specified in [Dialogs API](https://vuetifyjs.com/en/components/dialogs/).
